...
```{r poopy-counts, echo=FALSE, fig.pos="placeHere"}
set.seed(101010)
...
```{r poopy-freq, echo=FALSE, fig.pos="placeHere"}
br = seq(0,1,by=0.05)
...
```{r poopy-hist, echo=FALSE, fig.cap='Histogram of Poopiness', fig.pos="placeHere"}
...
```{r poopy-hist-alt, echo=FALSE, fig.cap='Other Histograms of Poopiness', fig.pos="placeHere"}
par(mfrow=c(1,2))
...
```{r poopy-two-kinds, echo=FALSE, fig.cap='This is a terrible, horrible, no-good, very-bad thing to do.', fig.pos="placeHere"}
...
```{r poopy-hist2, echo=FALSE, fig.pos="placeHere"}
...
```{r poopy-hist-mixture, echo=FALSE, fig.cap='A mixture of poopiness', fig.pos="placeHere"}
...
```{r poopy-hist-mixture-suspicious, echo=FALSE, fig.cap='A suspicious mixture of poopiness', fig.pos="placeHere"}
...
```{r crappy-hist, echo=FALSE, fig.cap='Histogram of Crappiness', fig.pos="placeHere"}
...
```{r poopy-crappy, echo=FALSE, fig.cap='Scatterplot of Crappiness vs Poopiness',fig.pos="placeHere"}
