...
```{r tp-fig, echo=FALSE, fig.cap='The greate debate', out.width='10%', fig.show='hold'}
include_graphics(c("images/Toilet_paper_orientation_over.jpg",
                   "images/Toilet_paper_orientation_under.jpg"))
