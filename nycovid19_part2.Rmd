...
We will make some judicious use of dplyr here to simplify the outcome. Mostly, we want to get rid of unnecessary columns from the ACS table

```{r}
boro_join <- acs_boro_population %>% select(Borough, countyName=NAME, TotalPop) %>% 
