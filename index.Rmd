...
> "...the most important questions of life, which are for the most part only problems of probability. It may even be said, strictly speaking, that almost all our knowledge is only probabilistic."
>
...
```{r xkcd-preamble, echo=FALSE, fig.cap='Hopefully you are in the right place. Credit XKCD  [permalink](https://xkcd.com/1856/)'}
