...
> Test yourself:
>
> - MBTI-style at [16personalities.com](16personalities.com) or 
...
>   - General information about these test items: https://ipip.ori.org/
...
<!--
^[This type of response bias can still persist even when the specific situations are presented. For example, most people probably know they are supposed to disagree with the statement "it is okay to steal from your company if they don't pay you enough." (These types of questions do appear on application forms!)]
-->
