...
{\centering \includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/converge-binom-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{images/Drug_Investment} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wheelan_cancer <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
   \DataTypeTok{Drug =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"Drug"}\NormalTok{, }\DecValTok{1}\OperatorTok{:}\DecValTok{1000}\NormalTok{), }\CommentTok{# this is just a dummy ID}
   \DataTypeTok{Cure =} \KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\StringTok{"No"}\NormalTok{,}\DecValTok{700}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"Yes"}\NormalTok{,}\DecValTok{300}\NormalTok{)), }\CommentTok{# 70% of drugs will fail to cure}
   \DataTypeTok{Approved =} \KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DecValTok{700}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"No"}\NormalTok{,}\DecValTok{120}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"Yes"}\NormalTok{,}\DecValTok{180}\NormalTok{)),}
   \DataTypeTok{First2Market =} \KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DecValTok{820}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"No"}\NormalTok{, }\DecValTok{18}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"Yes"}\NormalTok{,}\DecValTok{162}\NormalTok{)),}
   \DataTypeTok{Payout =} \KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\DecValTok{250000}\NormalTok{,}\DecValTok{700}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{120}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{18}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\DecValTok{25000000}\NormalTok{,}\DecValTok{162}\NormalTok{))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.9\linewidth,]{carpedatum_files/figure-latex/unnamed-chunk-28-1} \end{center}
...
\NormalTok{nbaHeights <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(nba_heights}\OperatorTok{$}\NormalTok{h_in, }\DecValTok{100}\NormalTok{) }
\CommentTok{# rename the male height to match}
\NormalTok{maleHeights <-}\StringTok{ }\NormalTok{male_heights}\OperatorTok{$}\NormalTok{heights}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/unnamed-chunk-33-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/unnamed-chunk-33-2} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/compareheights-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(NHANES) }\CommentTok{#}
\KeywordTok{library}\NormalTok{(dplyr)}

\NormalTok{lotsoheights <-}\StringTok{ }\NormalTok{NHANES }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Gender }\OperatorTok{==}\StringTok{ "male"} \OperatorTok{&}\StringTok{ }\NormalTok{Age }\OperatorTok{>}\StringTok{ }\DecValTok{18}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{                                }\KeywordTok{select}\NormalTok{(Height) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{unlist}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}
\CommentTok{# convert cm to in}
\NormalTok{lotsoheights <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(lotsoheights) }\OperatorTok{/}\StringTok{ }\FloatTok{2.54}

\CommentTok{# plot as before}
\KeywordTok{hist}\NormalTok{(lotsoheights, }\DataTypeTok{col=}\NormalTok{malescol, }\DataTypeTok{breaks=}\NormalTok{mybreaks, }
          \DataTypeTok{main=}\StringTok{"Heights of 3600 males"}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{"Height (inches)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\NormalTok{thresholdDiff <-}\StringTok{ }\DecValTok{9}
\CommentTok{# compute percentage of events outside of this threshold}
\NormalTok{numExtreme <-}\StringTok{ }\KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(}\KeywordTok{abs}\NormalTok{(differences_in_means) }\OperatorTok{>}\StringTok{ }\NormalTok{thresholdDiff))}
\NormalTok{percentExtreme <-}\StringTok{ }\NormalTok{numExtreme}\OperatorTok{/}\NormalTok{numSamples }\OperatorTok{*}\StringTok{ }\DecValTok{100}
\KeywordTok{paste0}\NormalTok{(percentExtreme,}\StringTok{"%"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.7\linewidth]{images/hockeybirths} 
...
{\centering \includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/marathon-times-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{carpedatum_files/figure-latex/marathon-fast-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyc_age_data}\OperatorTok{$}\NormalTok{CFR <-}\StringTok{ }\KeywordTok{round}\NormalTok{(nyc_age_data}\OperatorTok{$}\NormalTok{DEATH_RATE}\OperatorTok{/}\NormalTok{nyc_age_data}\OperatorTok{$}\NormalTok{COVID_CASE_RATE, }\DecValTok{3}\NormalTok{)}
\NormalTok{nyc_age_data}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# nyc_age_data$CFR <- round(nyc_age_data$DEATH_RATE/nyc_age_data$COVID_CASE_RATE, 3)}

\CommentTok{# another way using dplyr}
\NormalTok{nyc_age_data <-}\StringTok{ }\NormalTok{nyc_age_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{CFR =} \KeywordTok{round}\NormalTok{(DEATH_RATE}\OperatorTok{/}\NormalTok{COVID_CASE_RATE,}\DecValTok{3}\NormalTok{))}
\NormalTok{nyc_age_data}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{boroNames <-}\StringTok{ }\NormalTok{nyc_boro_data}\OperatorTok{$}\NormalTok{BOROUGH_GROUP[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\CommentTok{# County names}
\NormalTok{countyNames <-}\StringTok{ }\NormalTok{acs_boro_population}\OperatorTok{$}\NormalTok{NAME}

\CommentTok{# combine, but note that the order is not the same! So we'll reorder}
\NormalTok{boro2county <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Borough=}\NormalTok{boroNames, }\DataTypeTok{County=}\NormalTok{countyNames[}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{)], }
                          \DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}

\CommentTok{# create two 'named vectors'}
\CommentTok{# one for getting the borough}
\NormalTok{getBoro <-}\StringTok{ }\NormalTok{boro2county}\OperatorTok{$}\NormalTok{Borough}
\KeywordTok{names}\NormalTok{(getBoro) <-}\StringTok{ }\NormalTok{boro2county}\OperatorTok{$}\NormalTok{County}

\CommentTok{# one for getting the county}
\NormalTok{getCounty <-}\StringTok{ }\NormalTok{boro2county}\OperatorTok{$}\NormalTok{County}
\KeywordTok{names}\NormalTok{(getCounty) <-}\StringTok{ }\NormalTok{boro2county}\OperatorTok{$}\NormalTok{Borough}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{acs_boro_population}\OperatorTok{$}\NormalTok{Borough <-}\StringTok{ }\NormalTok{getBoro[acs_boro_population}\OperatorTok{$}\NormalTok{NAME]}
\NormalTok{acs_boro_population}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boro_join <-}\StringTok{ }\NormalTok{acs_boro_population }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(Borough, countyName, Total_Pop) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{left_join}\NormalTok{(nyc_boro_data, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"Borough"}\NormalTok{ =}\StringTok{  "BOROUGH_GROUP"}\NormalTok{))}
\NormalTok{boro_join}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boro_join}\OperatorTok{$}\NormalTok{RATE_100K <-}\StringTok{  }\KeywordTok{round}\NormalTok{(boro_join}\OperatorTok{$}\NormalTok{COVID_CASE_COUNT}\OperatorTok{/}\NormalTok{boro_join}\OperatorTok{$}\NormalTok{Total_Pop }\OperatorTok{*}\StringTok{ }\DecValTok{100000}\NormalTok{, }\DecValTok{2}\NormalTok{)}
\NormalTok{boro_join }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(Borough, COVID_CASE_RATE, RATE_100K)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# so I didn't have to do it ahead of time}

\KeywordTok{left_join}\NormalTok{(boro_join, }
\NormalTok{          acs_boro_income }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\DataTypeTok{countyName=}\NormalTok{NAME, Median_HH_Income, Median_Income), }
          \DataTypeTok{by=}\StringTok{"countyName"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# acs_groups <- listCensusMetadata(name = "acs/acs5", vintage = 2018, type = "groups")}
\CommentTok{# head(acs_groups)}

\CommentTok{# here are the variables in the SEX BY AGE group}
\NormalTok{group_B01001 <-}\StringTok{ }\KeywordTok{listCensusMetadata}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                                   \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                                   \DataTypeTok{type =} \StringTok{"variables"}\NormalTok{,}
                                   \DataTypeTok{group =} \StringTok{"B01001"}\NormalTok{)}
\KeywordTok{head}\NormalTok{(group_B01001[}\KeywordTok{order}\NormalTok{(group_B01001}\OperatorTok{$}\NormalTok{name),], }\DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myVars <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"B01001_0"}\NormalTok{,}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%02d"}\NormalTok{, }\DecValTok{20}\OperatorTok{:}\DecValTok{30}\NormalTok{), }\StringTok{"E"}\NormalTok{)}
\NormalTok{group_B01001 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(name }\OperatorTok{%in%}\StringTok{ }\NormalTok{myVars) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(name)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{maleOver65Vars <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"B01001_020E"}\NormalTok{,}\StringTok{"B01001_021E"}\NormalTok{,}\StringTok{"B01001_022E"}\NormalTok{,}\StringTok{"B01001_023E"}\NormalTok{,}
                    \StringTok{"B01001_024E"}\NormalTok{,}\StringTok{"B01001_025E"}\NormalTok{)}
\NormalTok{femaleOver65Vars <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"B01001_044E"}\NormalTok{,}\StringTok{"B01001_045E"}\NormalTok{,}\StringTok{"B01001_046E"}\NormalTok{,}\StringTok{"B01001_047E"}\NormalTok{,}
                      \StringTok{"B01001_048E"}\NormalTok{,}\StringTok{"B01001_049E"}\NormalTok{)}
\NormalTok{Total_PopVar <-}\StringTok{ "B01001_001E"}
\NormalTok{acs_boro_over65 <-}\StringTok{ }\KeywordTok{getCensus}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                           \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                           \DataTypeTok{vars =} \KeywordTok{c}\NormalTok{(}\StringTok{"NAME"}\NormalTok{, }
\NormalTok{                                    maleOver65Vars,femaleOver65Vars, Total_PopVar),}
                           \DataTypeTok{region =} \StringTok{"county:005,047,061,081,085"}\NormalTok{,}
                           \DataTypeTok{regionin =} \StringTok{"state:36"}\NormalTok{, }\DataTypeTok{key =}\NormalTok{ myKey}
\NormalTok{                         )}

\NormalTok{proportionOver65 <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{rowSums}\NormalTok{(acs_boro_over65[,}\DecValTok{4}\OperatorTok{:}\DecValTok{15}\NormalTok{])}\OperatorTok{/}\NormalTok{acs_boro_over65[,}\DecValTok{16}\NormalTok{],}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\DecValTok{100}
\NormalTok{boro_over65_proportions <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Borough=}\KeywordTok{unname}\NormalTok{(getBoro[acs_boro_over65}\OperatorTok{$}\NormalTok{NAME]), }
                                      \DataTypeTok{over65=}\NormalTok{proportionOver65)}
\NormalTok{boro_over65_proportions}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{group_B03002 <-}\StringTok{ }\KeywordTok{listCensusMetadata}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                                   \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                                   \DataTypeTok{type =} \StringTok{"variables"}\NormalTok{,}
                                   \DataTypeTok{group =} \StringTok{"B03002"}\NormalTok{)}
\KeywordTok{head}\NormalTok{(group_B03002[}\KeywordTok{order}\NormalTok{(group_B03002}\OperatorTok{$}\NormalTok{name),], }\DecValTok{20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# }
\NormalTok{someFruit <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"apple"}\NormalTok{, }\StringTok{"orange"}\NormalTok{, }\StringTok{"banana"}\NormalTok{, }\StringTok{"pear"}\NormalTok{)}
\KeywordTok{grep}\NormalTok{(}\StringTok{"e$"}\NormalTok{, someFruit)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{grep}\NormalTok{(}\StringTok{"e$"}\NormalTok{, someFruit, }\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{grep}\NormalTok{(}\StringTok{"(e|a)$"}\NormalTok{, someFruit, }\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(group_B03002[}\KeywordTok{grep}\NormalTok{(}\StringTok{"E$"}\NormalTok{, group_B03002}\OperatorTok{$}\NormalTok{name),])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{race_boro <-}\StringTok{ }\KeywordTok{getCensus}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                       \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                       \DataTypeTok{vars =} \KeywordTok{c}\NormalTok{(}\StringTok{"NAME"}\NormalTok{, }\StringTok{"B03002_001E"}\NormalTok{,}
                                \StringTok{"B03002_002E"}\NormalTok{,}\StringTok{"B03002_003E"}\NormalTok{,}\StringTok{"B03002_004E"}\NormalTok{, }
                                \StringTok{"B03002_006E"}\NormalTok{, }\StringTok{"B03002_012E"}  
\NormalTok{                                 ),}
                       \DataTypeTok{region =} \StringTok{"county:005,047,061,081,085"}\NormalTok{,}
                       \DataTypeTok{regionin =} \StringTok{"state:36"}\NormalTok{, }
                       \DataTypeTok{key =}\NormalTok{ myKey}
...
\CommentTok{# }
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_001E"}\NormalTok{)] <-}\StringTok{ "Total_HispRace"}
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_002E"}\NormalTok{)] <-}\StringTok{ "NH_Total"}
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_003E"}\NormalTok{)] <-}\StringTok{ "NH_White"}
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_004E"}\NormalTok{)] <-}\StringTok{ "NH_Black"}
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_006E"}\NormalTok{)] <-}\StringTok{ "NH_Asian"}
\KeywordTok{names}\NormalTok{(race_boro)[}\KeywordTok{which}\NormalTok{(}\KeywordTok{names}\NormalTok{(race_boro)}\OperatorTok{==}\StringTok{"B03002_012E"}\NormalTok{)] <-}\StringTok{ "Hisp_Latin"}

\CommentTok{# create the non-Hispanic Other category}
\NormalTok{race_boro <-}\StringTok{ }\NormalTok{race_boro }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{NH_Other =}\NormalTok{ NH_Total}\OperatorTok{-}\NormalTok{NH_Black}\OperatorTok{-}\NormalTok{NH_White}\OperatorTok{-}\NormalTok{NH_Asian) }
...
\NormalTok{race_boro_proportion <-}\StringTok{ }\NormalTok{race_boro  }\OperatorTok{%>%}\StringTok{ }\KeywordTok{transmute}\NormalTok{(}\DataTypeTok{Hisp_Latin =}\NormalTok{ Hisp_Latin}\OperatorTok{/}\NormalTok{Total_HispRace, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyc_zcta_covid <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/coronavirus-nyc/tests-by-zcta.csv"}\NormalTok{)}
\NormalTok{nyc_zipcodes <-}\StringTok{ }\NormalTok{nyc_zcta_covid }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(MODZCTA) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pull}\NormalTok{()}

\CommentTok{# for the API call, we will want all zipcodes }
\CommentTok{# in plain text with comma separation}
\NormalTok{nyc_zipcode_string <-}\StringTok{ }\KeywordTok{paste}\NormalTok{(nyc_zipcodes, }\DataTypeTok{collapse=}\StringTok{","}\NormalTok{)}

\CommentTok{# show beginning}
\KeywordTok{substr}\NormalTok{(nyc_zipcode_string, }\DecValTok{1}\NormalTok{,}\DecValTok{43}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{getRealName <-}\StringTok{ }\NormalTok{acsVars}\OperatorTok{$}\NormalTok{realName}
\KeywordTok{names}\NormalTok{(getRealName) <-}\StringTok{ }\NormalTok{acsVars}\OperatorTok{$}\NormalTok{acsName}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{zcta_over65 <-}\StringTok{ }\KeywordTok{getCensus}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                             \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                             \DataTypeTok{vars =} \KeywordTok{c}\NormalTok{(maleOver65Vars,femaleOver65Vars,Total_PopVar),}
                             \DataTypeTok{region =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"zip code tabulation area:"}\NormalTok{,nyc_zipcode_string),}
                             \DataTypeTok{key =}\NormalTok{ myKey}
\NormalTok{)}

\NormalTok{zcta_propOver65 <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{rowSums}\NormalTok{(zcta_over65[,}\DecValTok{2}\OperatorTok{:}\DecValTok{13}\NormalTok{])}\OperatorTok{/}\NormalTok{zcta_over65[,}\DecValTok{14}\NormalTok{],}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\DecValTok{100}
\CommentTok{# combine with zipcode column}
\NormalTok{zcta_propOver65 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{zipcode=}\NormalTok{zcta_over65}\OperatorTok{$}\NormalTok{zip_code_tabulation_area,}
\NormalTok{                         zcta_propOver65, }\DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}

\KeywordTok{head}\NormalTok{(zcta_propOver65)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{zcta_race <-}\StringTok{ }\KeywordTok{getCensus}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                       \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                       \DataTypeTok{vars =} \KeywordTok{c}\NormalTok{(}\StringTok{"B03002_012E"}\NormalTok{, }\StringTok{"B03002_004E"}\NormalTok{, }
                                \StringTok{"B03002_003E"}\NormalTok{, }\StringTok{"B03002_006E"}\NormalTok{,}
                                \StringTok{"B03002_002E"}\NormalTok{, }\StringTok{"B03002_001E"}\NormalTok{),}
                       \DataTypeTok{region =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"zip code tabulation area:"}\NormalTok{,nyc_zipcode_string),}
                       \DataTypeTok{key =}\NormalTok{ myKey}
\NormalTok{                       )}

\CommentTok{# rename the variables}
\KeywordTok{names}\NormalTok{(zcta_race) <-}\StringTok{ }\NormalTok{getRealName[}\KeywordTok{names}\NormalTok{(zcta_race)]}

\CommentTok{# create the non-Hispanic Other category}
\NormalTok{zcta_race <-}\StringTok{ }\NormalTok{zcta_race }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{NH_Other =}\NormalTok{ NH_Total}\OperatorTok{-}\NormalTok{NH_Black}\OperatorTok{-}\NormalTok{NH_White}\OperatorTok{-}\NormalTok{NH_Asian) }

\CommentTok{# convert to proportions by dividing by total}
\NormalTok{zcta_race_proportion <-}\StringTok{ }\NormalTok{zcta_race  }\OperatorTok{%>%}\StringTok{ }\KeywordTok{transmute}\NormalTok{(}\DataTypeTok{Hisp_Latin =}\NormalTok{ Hisp_Latin}\OperatorTok{/}\NormalTok{Total_HispRace, }
                                                 \DataTypeTok{NH_Black =}\NormalTok{ NH_Black}\OperatorTok{/}\NormalTok{Total_HispRace,}
                                                 \DataTypeTok{NH_White=}\NormalTok{NH_White}\OperatorTok{/}\NormalTok{Total_HispRace,}
                                                 \DataTypeTok{NH_Asian=}\NormalTok{NH_Asian}\OperatorTok{/}\NormalTok{Total_HispRace,}
                                                 \DataTypeTok{NH_Other=}\NormalTok{NH_Other}\OperatorTok{/}\NormalTok{Total_HispRace) }\OperatorTok{%>%}
...
\NormalTok{zcta_race_proportion <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(zcta_race }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(zipcode, Total_HispRace),}
\NormalTok{                              zcta_race_proportion) }
\KeywordTok{head}\NormalTok{(zcta_race_proportion)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{zcta_college_hh <-}\StringTok{ }\KeywordTok{getCensus}\NormalTok{(}\DataTypeTok{name =} \StringTok{"acs/acs5"}\NormalTok{,}
                             \DataTypeTok{vintage =} \DecValTok{2018}\NormalTok{,}
                             \DataTypeTok{vars =} \KeywordTok{c}\NormalTok{(}\StringTok{"B15003_022E"}\NormalTok{, }\StringTok{"B15003_023E"}\NormalTok{, }\StringTok{"B15003_024E"}\NormalTok{, }
                                      \StringTok{"B15003_025E"}\NormalTok{, }\StringTok{"B15003_001E"}\NormalTok{,}
                                      \StringTok{"B08201_007E"}\NormalTok{, }\StringTok{"B08201_013E"}\NormalTok{, }
                                      \StringTok{"B08201_019E"}\NormalTok{, }\StringTok{"B08201_025E"}\NormalTok{),}
                             \DataTypeTok{region =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"zip code tabulation area:"}\NormalTok{,nyc_zipcode_string),}
                             \DataTypeTok{key =}\NormalTok{ myKey}
\NormalTok{)}

\CommentTok{# give variable names}
\KeywordTok{names}\NormalTok{(zcta_college_hh) =}\StringTok{ }\NormalTok{getRealName[}\KeywordTok{names}\NormalTok{(zcta_college_hh)]}

\CommentTok{# Reports mention "College", but this presumably means Bachelors or higher}
\NormalTok{zcta_edu_hh <-}\StringTok{ }\NormalTok{zcta_college_hh }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Bach_plus_prop =} \KeywordTok{round}\NormalTok{( (Bachelors }\OperatorTok{+}\StringTok{ }\NormalTok{Masters }\OperatorTok{+}\StringTok{ }
\StringTok{                                                    }\NormalTok{Professional }\OperatorTok{+}\StringTok{ }
\StringTok{                                                    }\NormalTok{Doctorate)}\OperatorTok{/}\NormalTok{Total_EducPop,}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\DecValTok{100}\NormalTok{)}

\CommentTok{# create the average household size variable}
\NormalTok{zcta_edu_hh <-}\StringTok{ }\NormalTok{zcta_edu_hh }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{zcta_join <-}\StringTok{ }\NormalTok{zcta_income }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{left_join}\NormalTok{(zcta_propOver65, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"zipcode"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(zcta_SexByAge, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"zipcode"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(zcta_race_proportion, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"zipcode"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(zcta_edu_hh, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"zipcode"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(nyc_zipcode_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{zipcode =} \KeywordTok{as.character}\NormalTok{(zipcode)), }
            \DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"zipcode"}\NormalTok{))}

\KeywordTok{names}\NormalTok{(zcta_join)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{shapezips <-}\StringTok{ }\NormalTok{NYC_zips}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{ZIPCODE }
\KeywordTok{length}\NormalTok{(shapezips)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{quantile}\NormalTok{(someNormalData, }\DataTypeTok{probs =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DataTypeTok{length.out=}\DecValTok{6}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{cut}\NormalTok{(someNormalData, .) }\OperatorTok{%>%}\StringTok{ }\NormalTok{levels}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{getShapeColors <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{missingcol=}\StringTok{"gray88"}\NormalTok{, }
                           \DataTypeTok{rdgrbl=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{), }\DataTypeTok{mycolors=}\OtherTok{NULL}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{(}\KeywordTok{length}\NormalTok{(nbreaks) }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{) \{}
\NormalTok{    mybreaks <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{, }\KeywordTok{quantile}\NormalTok{(data,}
                               \DataTypeTok{probs =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DataTypeTok{length.out=}\NormalTok{nbreaks}\OperatorTok{+}\DecValTok{1}\NormalTok{),}
                               \DataTypeTok{na.rm =}\NormalTok{ T))}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{    mybreaks <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,nbreaks)}
\NormalTok{  \}}
  \ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.null}\NormalTok{(mycolors))\{}
\NormalTok{    mycols <-}\StringTok{ }\NormalTok{mycolors}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{    mycols <-}\StringTok{ }\KeywordTok{rgb}\NormalTok{(rdgrbl[}\DecValTok{1}\NormalTok{],rdgrbl[}\DecValTok{2}\NormalTok{],rdgrbl[}\DecValTok{3}\NormalTok{],}
                  \KeywordTok{seq}\NormalTok{(}\FloatTok{0.05}\NormalTok{,}\FloatTok{0.65}\NormalTok{, }\DataTypeTok{length.out =} \KeywordTok{length}\NormalTok{(mybreaks)}\OperatorTok{-}\DecValTok{1}\NormalTok{))}
\NormalTok{  \}}
\NormalTok{  mycols[}\DecValTok{1}\NormalTok{] <-}\StringTok{ }\NormalTok{missingcol}
\NormalTok{  data[}\KeywordTok{is.na}\NormalTok{(data)] <-}\StringTok{ }\FloatTok{-.1}
\NormalTok{  mycolorscheme <-}\StringTok{ }\KeywordTok{cut}\NormalTok{(data, mybreaks) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as.numeric}\NormalTok{()}
\NormalTok{  mycolorscheme <-}\StringTok{ }\NormalTok{mycols[mycolorscheme]}
\NormalTok{  levs <-}\StringTok{ }\KeywordTok{levels}\NormalTok{(}\KeywordTok{cut}\NormalTok{(data, mybreaks))}
\NormalTok{  levs[}\DecValTok{1}\NormalTok{] <-}\StringTok{ "No Data"}
  \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{regionValues=}\NormalTok{mycolorscheme, }
              \DataTypeTok{legendText=}\NormalTok{levs, }
              \DataTypeTok{legendColors=}\NormalTok{mycols))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bachelorPlus <-}\StringTok{ }\NormalTok{mapData}\OperatorTok{$}\NormalTok{Bach_plus_prop}
\NormalTok{myShapeColors <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"Share of Adults with College Degree"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }
       \DataTypeTok{title =} \StringTok{"College Prop"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myShapeColors <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{mycolors=}\KeywordTok{viridis}\NormalTok{(}\DecValTok{6}\NormalTok{))}

\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"Share of Adults with College Degree"}\NormalTok{, }\DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"College Prop"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ABCpalette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"gray88"}\NormalTok{, }\StringTok{"#4e9ccb"}\NormalTok{, }\StringTok{"#3b7ba9"}\NormalTok{,}\StringTok{"#265982"}\NormalTok{, }\StringTok{"#133960"}\NormalTok{,}\StringTok{"#001a3a"}\NormalTok{)}
\NormalTok{myShapeColors <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{mycolors=}\NormalTok{ABCpalette)}

\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"Share of Adults with College Degree"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{border=}\StringTok{"white"}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"College Share"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-91-1} \end{center}

Here is the original again.

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{images/abc_CollegeDegreeNycZip_v02_KA_hpEmbed_17x12_992} 
...
\begin{Highlighting}[]
\NormalTok{ABCpalette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"gray88"}\NormalTok{, }\StringTok{"#4e9ccb"}\NormalTok{, }\StringTok{"#3b7ba9"}\NormalTok{,}\StringTok{"#265982"}\NormalTok{, }\StringTok{"#133960"}\NormalTok{,}\StringTok{"#001a3a"}\NormalTok{)}
\NormalTok{myShapeColors <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DecValTok{60}\NormalTok{,}\DecValTok{80}\NormalTok{,}\DecValTok{100}\NormalTok{),}
                                 \DataTypeTok{mycolors=}\NormalTok{ABCpalette)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-92-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{ABCpalette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"gray88"}\NormalTok{, }\StringTok{"#4e9ccb"}\NormalTok{, }\StringTok{"#3b7ba9"}\NormalTok{,}\StringTok{"#265982"}\NormalTok{, }\StringTok{"#133960"}\NormalTok{,}\StringTok{"#001a3a"}\NormalTok{)}
\NormalTok{myShapeColors1 <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{,}
                                 \DataTypeTok{mycolors=}\NormalTok{ABCpalette)}
\NormalTok{myShapeColors2 <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DecValTok{60}\NormalTok{,}\DecValTok{80}\NormalTok{,}\DecValTok{100}\NormalTok{),}
                                 \DataTypeTok{mycolors=}\NormalTok{ABCpalette)}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}

\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"%College using Quintiles"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{border=}\StringTok{"white"}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"College Share"}\NormalTok{)}


\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"%College using Equal Intervals"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{border=}\StringTok{"white"}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"College Share"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{covidPerCapita <-}\StringTok{ }\NormalTok{mapData}\OperatorTok{$}\NormalTok{Positive}\OperatorTok{/}\NormalTok{mapData}\OperatorTok{$}\NormalTok{Total_Pop}\OperatorTok{*}\DecValTok{100}
\KeywordTok{hist}\NormalTok{(covidPerCapita, }\DataTypeTok{main=}\StringTok{"Zipcode-level Positive Cases Percent of Population"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-94-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myShapeColors1 <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(covidPerCapita, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{)}
\NormalTok{myShapeColors2 <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{)}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}

\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"%COVID Cases"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{border=}\StringTok{"white"}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors1}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"COVID rate"}\NormalTok{)}


\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{main =} \StringTok{"%College"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{border=}\StringTok{"white"}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }
       \DataTypeTok{legend =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{legendText, }
       \DataTypeTok{fill =}\NormalTok{ myShapeColors2}\OperatorTok{$}\NormalTok{legendColors, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{title =} \StringTok{"College Share"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myShapeColorsCovid <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(covidPerCapita, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{rdgrbl=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{))}
\NormalTok{myShapeColorsCollege <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(bachelorPlus, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{rdgrbl=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"covid"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCollege}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"college"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{) }
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"covid+college"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCollege}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{add=}\NormalTok{T, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-96-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{myShapeColorsCovid <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(covidPerCapita, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{rdgrbl=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{))}
\NormalTok{myShapeColorsHH <-}\StringTok{ }\KeywordTok{getShapeColors}\NormalTok{(mapData}\OperatorTok{$}\NormalTok{AvgHH, }\DataTypeTok{nbreaks=}\DecValTok{5}\NormalTok{, }\DataTypeTok{rdgrbl=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"covid"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsHH}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"hh size"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{) }
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"covid+hhsize"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsHH}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{add=}\NormalTok{T, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-97-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{), }\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{main =} \StringTok{"covid+hhsize"}\NormalTok{, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(NYC_zips, }\DataTypeTok{col =}\NormalTok{ myShapeColorsHH}\OperatorTok{$}\NormalTok{regionValues, }\DataTypeTok{add=}\NormalTok{T, }
     \DataTypeTok{cex =} \DecValTok{10}\NormalTok{, }\DataTypeTok{lwd=}\FloatTok{0.05}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(mapData}\OperatorTok{$}\NormalTok{AvgHH, covidPerCapita, }\DataTypeTok{col=}\NormalTok{myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{pch=}\DecValTok{16}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{""}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{""}\NormalTok{)}
\KeywordTok{points}\NormalTok{(mapData}\OperatorTok{$}\NormalTok{AvgHH, covidPerCapita, }\DataTypeTok{col=}\NormalTok{myShapeColorsHH}\OperatorTok{$}\NormalTok{regionValues, }
       \DataTypeTok{pch=}\DecValTok{16}\NormalTok{)}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"Avg Household Size"}\NormalTok{, }\DataTypeTok{side =} \DecValTok{1}\NormalTok{, }\DataTypeTok{line =} \DecValTok{2}\NormalTok{)}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"COVID rate"}\NormalTok{, }\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{line =} \DecValTok{2}\NormalTok{)}
...
\KeywordTok{plot}\NormalTok{(mapData}\OperatorTok{$}\NormalTok{Bach_plus_prop, covidPerCapita, }\DataTypeTok{col=}\NormalTok{myShapeColorsCovid}\OperatorTok{$}\NormalTok{regionValues, }
     \DataTypeTok{pch=}\DecValTok{16}\NormalTok{,}
     \DataTypeTok{xlab=}\StringTok{""}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{""}\NormalTok{)}
\KeywordTok{points}\NormalTok{(mapData}\OperatorTok{$}\NormalTok{Bach_plus_prop, covidPerCapita, }\DataTypeTok{col=}\NormalTok{myShapeColorsCollege}\OperatorTok{$}\NormalTok{regionValues, }
       \DataTypeTok{pch=}\DecValTok{16}\NormalTok{)}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"College Percentage"}\NormalTok{, }\DataTypeTok{side =} \DecValTok{1}\NormalTok{, }\DataTypeTok{line =} \DecValTok{2}\NormalTok{)}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"COVID rate"}\NormalTok{, }\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{line =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
