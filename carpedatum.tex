...
\NormalTok{shapezips }\OtherTok{\textless{}{-}}\NormalTok{ NYC\_zips}\SpecialCharTok{@}\NormalTok{data}\SpecialCharTok{$}\NormalTok{ZIPCODE }
...
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColors}\SpecialCharTok{$}\NormalTok{regionValues, }
...
\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-html/unnamed-chunk-91-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{carpedatum_files/figure-html/unnamed-chunk-92-1} \end{center}
...
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColors1}\SpecialCharTok{$}\NormalTok{regionValues, }
...
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColors2}\SpecialCharTok{$}\NormalTok{regionValues, }
...
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCovid}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"covid"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCollege}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"college"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{) }
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCovid}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"covid+college"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCollege}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{add=}\NormalTok{T, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCovid}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"covid"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsHH}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"hh size"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{) }
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsCovid}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{main =} \StringTok{"covid+hhsize"}\NormalTok{, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(NYC\_zips, }\AttributeTok{col =}\NormalTok{ myShapeColorsHH}\SpecialCharTok{$}\NormalTok{regionValues, }\AttributeTok{add=}\NormalTok{T, }
     \AttributeTok{cex =} \DecValTok{10}\NormalTok{, }\AttributeTok{lwd=}\FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
