...
The development of probability theory is historically linked to attempts to understand games of chance, especially ones in which money was involved (see for example, the optional reading). Sometimes betting money on an uncertain outcome falls under the name of gambling; other times it’s dignified with the name investment.  But regardless of the label, there are smarter and less smart ways to play money games. 
...
OPTIONAL READING: http://sites.math.rutgers.edu/~cherlin/History/Papers2000/cheng.html
Week 7 Video 2
