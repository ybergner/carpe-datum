...
> Think about this: Now that we have added replacement to the sampling process, if we sample 40 times, are we guaranteed to get 23 overs and 17 unders?
...
```{r echo = TRUE}
set.seed(2129981212) # I can choose any see I want
numPeople <- 10
