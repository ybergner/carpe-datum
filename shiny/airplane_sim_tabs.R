         ...
         #  textOutput("result1"),
          ...
          # textOutput("result2")
           ...
           tabsetPanel(type = "tabs",
                       tabPanel("Run Once", h4("Run Simulation Once:"), h6("Use the inputs to the left change the percent chance that any individual shows up for the flight, the cost per ticket, the payout by airlines to anyone 
                                who has to switch planes and the number of tickets sold per plane (assuming that each plane has 100 seats). Click 'Run Once' to see the airline's net profit 
                                or loss for one plane. Click the button again to see how the simulation might vary given the probability of showing up. Change the parameters and click the button again to see how the result changes."), textOutput("result2")),
                       tabPanel("Run 100 Times",h4("Run Similation 100 Times:"),h6("Use the inputs to the left change the percent chance that any individual shows up for the flight, the cost per ticket, the payout by airlines to anyone 
                                who has to switch planes and the number of tickets sold per plane (assuming that each plane has 100 seats). Click 'Run 100 Times' to see the airline's net profit 
                                or loss for 100 flights. Change the parameters and click the button again to see how the result changes."), plotOutput("hist"), textOutput("result1"))
